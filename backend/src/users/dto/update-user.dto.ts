...
export class UpdateUserDto {
  @ApiProperty({ example: 'Carlos Lima', required: false })
  @IsString()
  @IsOptional()
  name?: string;
  ...
  @ApiProperty({ example: 'carlos.lima@company.com', required: false })
  @IsEmail()
  @IsOptional()
  email?: string;
  ...
  @ApiProperty({ example: 'employee', enum: Role, required: false })
  @IsEnum(Role)
  @IsOptional()
  role?: Role;
