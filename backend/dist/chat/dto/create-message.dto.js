...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "Olá, como posso solicitar férias?" }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateMessageDto.prototype, "message", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "user", enum: ["user", "bot", "system"] }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(["user", "bot", "system"]),
    __metadata("design:type", String)
